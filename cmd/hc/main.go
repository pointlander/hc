...
func runSim(args []string) int {
	...
	width := fs.Float64("width", 40e-3, "E width along the spine, m")
	height := fs.Float64("height", 50e-3, "E height along the tines, m")
	spine := fs.Float64("spine", 8e-3, "spine bar thickness, m")
	arm := fs.Float64("arm", 8e-3, "tine width, m")
